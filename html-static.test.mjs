...
assert.match(app, /usedAnswersByMode/);
assert.match(app, /createManagedGame/);
assert.match(app, /GameCore\.getWordsForMode/);
assert.match(app, /\/api\/ai-word/);
assert.match(app, /requestAiWord/);
assert.match(app, /GameCore\.createGameFromWord/);
...
assert.match(css, /--keyboard-inset: 0px/);
assert.match(css, /bottom: var\(--keyboard-inset\)/);
