...
assert.match(app, /brand-logo/);
assert.match(app, /assets\/logo\.png/);
assert.match(app, /작게 답답한 친구가 설명하는 걸 맞혀봐/);
...
assert.match(css, /\.mode-icon[\s\S]*width: 78px/);
